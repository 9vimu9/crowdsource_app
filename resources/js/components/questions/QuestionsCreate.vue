<template>
    <div  class="p-6 mb-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-100 dark:border-gray-700 lg:mb-0">
        <p class="font-normal text-white">
            {{ paragraph.paragraph }}
        </p>
    </div>
    <h3 class="ml-auto text-lg text-black mt-10 ">අලුත් ප්‍රශ්නය පහල කොටුවේ type කරන්න </h3>
    <div class="flex flex-col space-y-4 ">
        ...
        <hr>
        <h3 class="ml-auto text-lg text-black ">කලින් හදපු ප්‍රශ්න </h3>
        <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
            <div class="py-2 px-4 bg-white rounded-t-lg dark:bg-gray-800">
                <textarea
                    id="comment"
